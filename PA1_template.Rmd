...
cbind(dataperdayFormat[1:(dim(dataperday)[1]/4),],dataperdayFormat[(dim(dataperday)[1]/4)+1:(dim(dataperday)[1]/4),],dataperdayFormat[(dim(dataperday)[1]/2)+1:(dim(dataperday)[1]/4),],dataperdayFormat[(dim(dataperday)[1]*3/4)+1:(dim(dataperday)[1]/4),], dataperdayFormat[dim(dataperday)[1],])->dataperdayord
dataperdayord[2:13,9:10]<-""
names(dataperdayord)<-c("Date", " Total Steps","Date", " Total Steps","Date", " Total Steps","Date", " Total Steps","Date", " Total Steps")
xt <-xtable(dataperdayord, align ="rrcrcrcrcrc")
##align(xt) <- "l|lr|lr|lr|lr|lr"
...
***The five minutes interval, averaged across days, that contains the maximum number of steps is `r maxinterval`.***
...
##Histogram of the total number os steps after filling NA's
...
factor((weekdays(modactivity$date) %in% weekend1), levels=c(FALSE, TRUE), labels=c("weekday", "weekend") )->modactivity$Weekend
